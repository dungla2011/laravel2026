 ...
 * @param null $objData
 */
class MailLog_Meta extends MetaOfTableInDb
{
//    protected static $api_url_admin = "/api/mail-log";
//    protected static $web_url_admin = "/admin/mail-log";
//
//    protected static $api_url_member = "/api/member-mail-log";
//    protected static $web_url_member = "/member/mail-log";

    //public static $folderParentClass = MailLogFolderTbl::class;
    public static $modelClass = MailLog::class;
...
//          $objMeta->join_func = 'joinTags';
            //MailLog edit, tag sẽ ko update được?
            $objMeta->join_relation_func = 'joinTags';
            $objMeta->join_api = '/api/tags/search';
            $objMeta->dataType = DEF_DATA_TYPE_ARRAY_NUMBER;
        }
        if($field == 'mail_content' || $field == 'parent_all' ){
...
//            $objMeta->join_func = 'App\Models\MailLogFolderTbl::joinFuncPathNameFullTree';
        }
