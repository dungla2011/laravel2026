 ...
 * @param null $objData
 */
class TestMongo1_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/test-mongo1";
    protected static $web_url_admin = "/admin/test-mongo1";

    protected static $api_url_member = "/api/member-test-mongo1";
    protected static $web_url_member = "/member/test-mongo1";

    //public static $folderParentClass = TestMongo1FolderTbl::class;
    public static $modelClass = TestMongo1::class;
...
//          $objMeta->join_func = 'joinTags';
            //TestMongo1 edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\TestMongo1FolderTbl::joinFuncPathNameFullTree';
        }
