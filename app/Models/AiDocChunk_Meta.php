 ...
 * @param null $objData
 */
class AiDocChunk_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/ai-doc-chunk";
    protected static $web_url_admin = "/admin/ai-doc-chunk";

    protected static $api_url_member = "/api/member-ai-doc-chunk";
    protected static $web_url_member = "/member/ai-doc-chunk";

    //public static $folderParentClass = AiDocChunkFolderTbl::class;
    public static $modelClass = AiDocChunk::class;
...
//          $objMeta->join_func = 'joinTags';
            //AiDocChunk edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\AiDocChunkFolderTbl::joinFuncPathNameFullTree';
        }
