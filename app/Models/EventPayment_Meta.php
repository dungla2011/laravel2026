 ...
 * @param null $objData
 */
class EventPayment_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/event-payment";
    protected static $web_url_admin = "/admin/event-payment";

    protected static $api_url_member = "/api/member-event-payment";
    protected static $web_url_member = "/member/event-payment";

    //public static $folderParentClass = EventPaymentFolderTbl::class;
    public static $modelClass = EventPayment::class;
...
//          $objMeta->join_func = 'joinTags';
            //EventPayment edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\EventPaymentFolderTbl::joinFuncPathNameFullTree';
        }
