 ...
 * @param null $objData
 */
class PlanCostItem_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/cost-item";
    protected static $web_url_admin = "/admin/cost-item";

    protected static $api_url_member = "/api/member-cost-item";
    protected static $web_url_member = "/member/cost-item";

    //public static $folderParentClass = PlanCostItemFolderTbl::class;
    public static $modelClass = PlanCostItem::class;
...
//          $objMeta->join_func = 'joinTags';
            //PlanCostItem edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\PlanCostItemFolderTbl::joinFuncPathNameFullTree';
        }
