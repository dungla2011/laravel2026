 ...
 * @param null $objData
 */
class MediaActor_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/media-actor";
    protected static $web_url_admin = "/admin/media-actor";

    protected static $api_url_member = "/api/member-media-actor";
    protected static $web_url_member = "/member/media-actor";

    //public static $folderParentClass = MediaActorFolderTbl::class;
    public static $modelClass = MediaActor::class;
...
//          $objMeta->join_func = 'joinTags';
            //MediaActor edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\MediaActorFolderTbl::joinFuncPathNameFullTree';
        }
