 ...
 * @param null $objData
 */
class CartItem_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/cart-item";
    protected static $web_url_admin = "/admin/cart-item";

    protected static $api_url_member = "/api/member-cart-item";
    protected static $web_url_member = "/member/cart-item";

    //public static $folderParentClass = CartItemFolderTbl::class;
    public static $modelClass = CartItem::class;
...
//          $objMeta->join_func = 'joinTags';
            //CartItem edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\CartItemFolderTbl::joinFuncPathNameFullTree';
        }
...
//            $objMeta->join_func = 'App\Models\CartItemFolderTbl::joinFuncPathNameFullTree';
    ...
    function _product_id($obj, $val, $field)
    {
        $ret = '';
        $product = Product::find($val);
        if($product)
            $ret = "<div class='m-2'> $product->name </div>";
