 ...
 * @param null $objData
 */
class AssetCategory_Meta extends MetaOfTableInDb
{
    public static $api_url_admin = "/api/asset-category";
    public static $web_url_admin = "/admin/asset-category";

    protected static $api_url_member = "/api/member-asset-category";
    protected static $web_url_member = "/member/asset-category";

    //public static $folderParentClass = AssetCategoryFolderTbl::class;
    public static $modelClass = AssetCategory::class;
...
//          $objMeta->join_func = 'joinTags';
            //AssetCategory edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\AssetCategoryFolderTbl::joinFuncPathNameFullTree';
        }
...
//            $objMeta->join_func = 'App\Models\AssetCategoryFolderTbl::joinFuncPathNameFullTree';
    ...
    {
        return parent::getApiUrl($module); // TODO: Change the autogenerated stub
    }
    //...
