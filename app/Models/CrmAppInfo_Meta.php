 ...
 * @param null $objData
 */
class CrmAppInfo_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/crm-app-info";
    protected static $web_url_admin = "/admin/crm-app-info";

    protected static $api_url_member = "/api/member-crm-app-info";
    protected static $web_url_member = "/member/crm-app-info";

    //public static $folderParentClass = CrmAppInfoFolderTbl::class;
    public static $modelClass = CrmAppInfo::class;
    ...
    public function getHardCodeMetaObj($field){
        ...
        if($field == 'status' || $field == 'ready'){
            $objMeta->dataType = DEF_DATA_TYPE_STATUS;
        }
        if($field == 'tag_list_id'){
            $objMeta->join_api_field = 'name';
//          $objMeta->join_func = 'joinTags';
            //CrmAppInfo edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\CrmAppInfoFolderTbl::joinFuncPathNameFullTree';
        }
        if($field == 'firebase_token'){
