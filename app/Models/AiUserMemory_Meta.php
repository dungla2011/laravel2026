 ...
 * @param null $objData
 */
class AiUserMemory_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/ai-user-memory";
    protected static $web_url_admin = "/admin/ai-user-memory";

    protected static $api_url_member = "/api/member-ai-user-memory";
    protected static $web_url_member = "/member/ai-user-memory";

    //public static $folderParentClass = AiUserMemoryFolderTbl::class;
    public static $modelClass = AiUserMemory::class;
...
//          $objMeta->join_func = 'joinTags';
            //AiUserMemory edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\AiUserMemoryFolderTbl::joinFuncPathNameFullTree';
        }
