 ...
 * @param null $objData
 */
class PlanDefine_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/plan-define";
    protected static $web_url_admin = "/admin/plan-define";

    protected static $api_url_member = "/api/member-plan-define";
    protected static $web_url_member = "/member/plan-define";

    //public static $folderParentClass = PlanDefineFolderTbl::class;
    public static $modelClass = PlanDefine::class;
...
//          $objMeta->join_func = 'joinTags';
            //PlanDefine edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\PlanDefineFolderTbl::joinFuncPathNameFullTree';
        }
