 ...
 * @param null $objData
 */
class AiDocCategory_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/ai-doc-category";
    protected static $web_url_admin = "/admin/ai-doc-category";

    protected static $api_url_member = "/api/member-ai-doc-category";
    protected static $web_url_member = "/member/ai-doc-category";

    //public static $folderParentClass = AiDocCategoryFolderTbl::class;
    public static $modelClass = AiDocCategory::class;
...
//          $objMeta->join_func = 'joinTags';
            //AiDocCategory edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\AiDocCategoryFolderTbl::joinFuncPathNameFullTree';
        }
