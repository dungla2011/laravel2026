 ...
 * @param null $objData
 */
class PlanName_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/plan-name";
    protected static $web_url_admin = "/admin/plan-name";

    protected static $api_url_member = "/api/member-plan-name";
    protected static $web_url_member = "/member/plan-name";

    //public static $folderParentClass = PlanNameFolderTbl::class;
    public static $modelClass = PlanName::class;
...
//          $objMeta->join_func = 'joinTags';
            //PlanName edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\PlanNameFolderTbl::joinFuncPathNameFullTree';
        }
