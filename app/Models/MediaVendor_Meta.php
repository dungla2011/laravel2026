 ...
 * @param null $objData
 */
class MediaVendor_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/media-vendor";
    protected static $web_url_admin = "/admin/media-vendor";

    protected static $api_url_member = "/api/member-media-vendor";
    protected static $web_url_member = "/member/media-vendor";

    //public static $folderParentClass = MediaVendorFolderTbl::class;
    public static $modelClass = MediaVendor::class;
...
//          $objMeta->join_func = 'joinTags';
            //MediaVendor edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\MediaVendorFolderTbl::joinFuncPathNameFullTree';
        }
