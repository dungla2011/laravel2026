 ...
 * @param null $objData
 */
class MediaAuthor_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/media-author";
    protected static $web_url_admin = "/admin/media-author";

    protected static $api_url_member = "/api/member-media-author";
    protected static $web_url_member = "/member/media-author";

    //public static $folderParentClass = MediaAuthorFolderTbl::class;
    public static $modelClass = MediaAuthor::class;
...
//          $objMeta->join_func = 'joinTags';
            //MediaAuthor edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\MediaAuthorFolderTbl::joinFuncPathNameFullTree';
        }
