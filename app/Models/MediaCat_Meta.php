 ...
 * @param null $objData
 */
class MediaCat_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/media-cat";
    protected static $web_url_admin = "/admin/media-cat";

    protected static $api_url_member = "/api/member-media-cat";
    protected static $web_url_member = "/member/media-cat";

    //public static $folderParentClass = MediaCatFolderTbl::class;
    public static $modelClass = MediaCat::class;
...
//          $objMeta->join_func = 'joinTags';
            //MediaCat edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\MediaCatFolderTbl::joinFuncPathNameFullTree';
        }
