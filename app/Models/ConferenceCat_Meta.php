 ...
 * @param null $objData
 */
class ConferenceCat_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/conference-cat";
    protected static $web_url_admin = "/admin/conference-cat";

    protected static $api_url_member = "/api/member-conference-cat";
    protected static $web_url_member = "/member/conference-cat";

    //public static $folderParentClass = ConferenceCatFolderTbl::class;
    public static $modelClass = ConferenceCat::class;
...
//          $objMeta->join_func = 'joinTags';
            //ConferenceCat edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\ConferenceCatFolderTbl::joinFuncPathNameFullTree';
        }
