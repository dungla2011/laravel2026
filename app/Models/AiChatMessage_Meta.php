 ...
 * @param null $objData
 */
class AiChatMessage_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/ai-chat-message";
    protected static $web_url_admin = "/admin/ai-chat-message";

    protected static $api_url_member = "/api/member-ai-chat-message";
    protected static $web_url_member = "/member/ai-chat-message";

    //public static $folderParentClass = AiChatMessageFolderTbl::class;
    public static $modelClass = AiChatMessage::class;
...
//          $objMeta->join_func = 'joinTags';
            //AiChatMessage edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\AiChatMessageFolderTbl::joinFuncPathNameFullTree';
        }
