 ...
 * @param null $objData
 */
class ProductUsage_Meta extends MetaOfTableInDb
{
    protected static $api_url_admin = "/api/product-usage";
    protected static $web_url_admin = "/admin/product-usage";

    protected static $api_url_member = "/api/member-product-usage";
    protected static $web_url_member = "/member/product-usage";

    //public static $folderParentClass = ProductUsageFolderTbl::class;
    public static $modelClass = ProductUsage::class;
...
//          $objMeta->join_func = 'joinTags';
            //ProductUsage edit, tag sẽ ko update được?
...
//            $objMeta->join_func = 'App\Models\ProductUsageFolderTbl::joinFuncPathNameFullTree';
        }
