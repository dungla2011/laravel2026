 ...
 * @return simple_html_dom_node
 */
function str_get_html_keep_br($str)
{
    return str_get_html($str, 1, 1, DEFAULT_TARGET_CHARSET, 0);
}
...
class simple_html_dom_node
{
     ...
     * @return simple_html_dom_node
     */
    public function getDataAttr($dataField)
    {
        if (isset($this->$dataField)) {
     ...
     * @return simple_html_dom_node
     */
    public function findOne($selector, $pos = 0, $lowercase = false)
    {
        return $this->find($selector, $pos, $lowercase);
    }
...
class simple_html_dom
{
    ...
    //	function findInnerText($elm, $text){
    //
    //    }
