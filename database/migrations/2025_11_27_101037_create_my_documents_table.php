...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('my_documents', function (Blueprint $table) {
            ...
            $table->string('refer', 256)->nullable();
            ...
            $table->string('parent_list', 256)->nullable();
            $table->string('old_parent_list', 256)->nullable()->index();
            $table->string('file_list', 1024)->nullable()->index();
