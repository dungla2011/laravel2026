...
return new class extends Migration
{
    ...
    {
        Schema::create('quiz_user_classes', function (Blueprint $table) {
            ...
            $table->string('parent_list', 512)->nullable();
            $table->string('old_parent_list', 512)->nullable()->index();
    ...
    {
        Schema::dropIfExists('quiz_user_classes');
    }
};
