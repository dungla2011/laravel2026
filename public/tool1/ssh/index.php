...
<?php
//$_SERVER['SERVER_NAME'] = 'giapha1.mytree.vn';
...
<!doctype html>
  <html>
    <head>
      <link rel="stylesheet" href="https://galaxycloud.vn/train/ssh-web/PHP-SSH2-Web-Client/node_modules/xterm/dist/xterm.css" />
      <script src="https://galaxycloud.vn/train/ssh-web/PHP-SSH2-Web-Client/node_modules/xterm/dist/xterm.js"></script>
      <script src="https://galaxycloud.vn/train/ssh-web/PHP-SSH2-Web-Client/node_modules/xterm/dist/addons/attach/attach.js"></script>
      <script src="https://galaxycloud.vn/train/ssh-web/PHP-SSH2-Web-Client/node_modules/xterm/dist/addons/fit/fit.js"></script>
    ...
    <body>
      <div id="serverbox" class="serverbox">
        ...
        <input type="text" id="server" name="server" title="server" placeholder="server" value="mytree.vn" /><br>
        ...
        <input type="text" id="user" name="user" title="user" placeholder="user" value="dhshop" /><br>
        <label for="psw"><b>Password</b></label><br>
        <input type="password" id="password" name="password" title="password" placeholder="password" value="qqqppp" /><br>
      ...
      <script>
        var resizeInterval;
        //var wSocket = new WebSocket("wss:mytree.vn:18080");

        try {
            var wSocket = new WebSocket("wss:sv992.galaxycloud.vn:20009");
            wSocket.onclose = function(evt) {
                alert("Can not connect to ssh server1!");
            };

            wSocket.onerror = function(evt) {
                alert("Can not connect to ssh server2!");

            };
        }
        catch(err) {
            alert("Can not connect to ssh server3!");
        }
