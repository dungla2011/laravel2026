...
$link = "https://nhuasonglong.vn/ghe-tua-d21.html";

$ct = file_get_html($link);

//Tìm link a, img, title, price
/*
<div class="div_noidung"><div class="truong anh"><a title="Ghế tựa trẻ em 2301" href="ghe-dau-2301-id43.html"><img alt="Ghế tựa trẻ em 2301" class="anh_sanpham_danhsach" src="files/sanpham/43/1/jpg/ghe-tua-tre-em-2301.jpg" width=""></a><a rel="nofollow" href="/giohang.html" class="bieutuongdamua bieutuongdamua bieutuongdamua43"><i class="fal fa-2x fa-shopping-bag"></i><span></span></a></div><h2 class="truong tieude"><a title="Ghế tựa trẻ em 2301" href="ghe-dau-2301-id43.html">Ghế tựa trẻ em 2301</a></h2><div class="gia"><strong>51.000</strong> <span>VND</span></div><div class="truong nutmuahang"><label class="nut_dat" onclick="dathang(43) ;"><span><i class="far fa-shopping-cart" aria-hidden="true"></i> Mua hàng</span></label></div>
</div>
 */
//Html o tren, hãy viết lại như đoaạn dưới
foreach ($ct->find(".div_noidung") AS $one) {
    $a1 = $one->find("a", 0)->href;

    $img = $one->find("img" , 0);
        $linkImg= "https://nhuasonglong.vn/".$img->src;
        if(!$img->src) {
            //Get data-src
            $linkImg = "https://nhuasonglong.vn/" . $img->getAttribute('data-src');
        }
        echo "<br/>\n IMG = $linkImg   ";

    $title = $one->find('.truong.tieude', 0)->text();
    echo "<br> Title = $title";
    //Price in strong
