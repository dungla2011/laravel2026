...
CREATE TABLE `user_groups` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_groups_old_id_index` (`old_id`),
  KEY `user_groups_user_id_index` (`user_id`),
  KEY `user_groups_old_user_id_index` (`old_user_id`),
  KEY `user_groups_status_index` (`status`),
  KEY `user_groups_old_image_list_index` (`old_image_list`)
