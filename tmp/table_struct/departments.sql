...
CREATE TABLE `departments` (
  ...
  PRIMARY KEY (`id`),
  KEY `departments_old_id_index` (`old_id`),
  KEY `departments_user_id_index` (`user_id`),
  KEY `departments_old_user_id_index` (`old_user_id`),
  KEY `departments_status_index` (`status`),
  KEY `departments_old_image_list_index` (`old_image_list`)
