...
//    var $primary;
    ...
    {
        $ret = [
            ['field' => 'show_index_mobile', 'is_status' => 1],
...
//    }
    ...
    function isSelectField($field) {
        ...
        if ($field == 'dataType') {
            ...
            $ret = [
                ...
                DEF_DATA_TYPE_HTML_SELECT_OPTION_MULTI_VALUE => '[Select Multi value]',
    ...
    {
        $mFieldHide = ['meta_all_set_api', 'table_name_model', 'created_at', 'updated_at', 'translations', 'readOnly', 'limit_user_edit', 'limit_dev_edit'];
