...
{{--                            <li class="breadcrumb-item" ppp0374590374958><a href="#"></a></li>--}}
        ...
        <section class="content" data-code-pos="ppp1682133061076">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-3" data-code-pos='ppp17268173447701'>
                        <span>
                            <?php
                            echo $user->email;
                            if(!$user->password)
                                echo "<br/>\n <a href='/reset-password' 111> Đặt mật khẩu </a>";
                            else
                                echo "<br/>\n <a href='/member/set-password' 111> Đặt mật khẩu </a>";
                            ?>
                        </span>
                    </div>
                    <div class="col-sm-6">
