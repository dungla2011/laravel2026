...
<!-- Thống kê -->
<div style="background: white; padding: 15px 0px; margin-bottom: 20px; border-radius: 5px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
    ...
    <div style="display: flex; gap: 10px; align-items: center;">
        ...
        <select id="global-time-range-selector" class="form-control form-control-sm" style="width: auto; min-width: 100px;padding: 2px 8px">
        ...
        <a href="/member/monitor-item" class="btn btn-primary btn-sm" style="padding: 3px 8px">
{{ __('member.monitor_report.view_all') }}
        </a>
        <a href="/member/monitor-item/create"> <i class="fas fa-plus-square fa-2x" style=""></i>  </a>
