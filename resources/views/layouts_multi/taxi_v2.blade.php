...
?>
<div class="content-wrapper" data-code-pos='ppp17637170840021'>
    <header class="wrapper" data-code-pos='ppp17598501642251'>
...
//                            // Nếu user đã login, ưu tiên language của user
//                            if ($user = getCurrentUserId(1)) {
//                                if ($user->language ?? '') {
//                                    $currentLocale = $user->language;
//                                    app()->setLocale($currentLocale); // Set locale theo user
//                                }
//                            }
