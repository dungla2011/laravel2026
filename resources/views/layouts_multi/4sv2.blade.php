...
<div class="content-wrapper">
    <header class="wrapper bg-soft-primary">
        <nav class="navbar navbar-expand-lg center-nav transparent position-absolute1 navbar-light caret-none" style="">
            <div class="container flex-lg-row flex-nowrap align-items-center">
                <div class="navbar-brand w-50">
                    <a href="/">

                        <h1 STYLE="margin: 0px">4SHARE.VN</h1>
...
{{--                             srcset="/images/logo/mytree1.png 2x" alt=""/>--}}
                ...
                <div class="navbar-collapse offcanvas-nav">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown" data-code-pos="qqq1634946265276">
                            <a class="nav-link has-submenu" href="#" id="sm-17288720516276145-1" aria-haspopup="true" aria-controls="sm-17288720516276145-2" aria-expanded="false">   Dịch vụ   <span class="sub-arrow"></span></a>
                            <ul class="dropdown-menu sm-nowrap hide-animation" data-code-pos="qqq1634946270926" id="sm-17288720516276145-2" role="group" aria-hidden="true" aria-labelledby="sm-17288720516276145-1" aria-expanded="false" style="width: auto; display: none; top: auto; left: 0px; margin-left: 0px; margin-top: 0px; min-width: 10rem; max-width: 25rem;">
                                <li class="nav-item">
                        ...
                        <li class='nav-item dropdown'>
                            <a class="nav-link" href="/member/file" >  Upload </a>
                        </li>
                        <li class='nav-item'>
                            <a class="nav-link" href='/buy-vip' > Mua VIP</a>
                        </li>
                        {{--                        <li class='nav-item'>--}}
                ...
                <div class="navbar-other w-100 d-flex ms-auto">
                    ...
                    <form class="search-form" action="/search-file">
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto1 ml-2" data-sm-skip="true">
