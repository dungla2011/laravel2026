...
<head data-code-pos='ppp17370203296921'>
    ...
    <meta name="keywords" content="Dịch vụ Tư vấn Tài chính dự án Kinh doanh, khởi nghiệp">

    <meta name="description" content="Dịch vụ Tư vấn Tài chính dự án Kinh doanh, khởi nghiệp" />

    <meta name="author" content="Startup.vn">
    <meta name="copyright" content="Startup.vn"/>

    <meta property="og:image" content="/images/4s/startup.jpg">
    <meta property="og:title" content="@yield('title')">
    <meta property="og:description" content="Startup.vn Dịch vụ Tư vấn Tài chính dự án Kinh doanh, khởi nghiệp">
        ...
        <div class="row gy-6 gy-lg-0">
            <div class="col-md-4 col-lg-3">
                <div class="widget">
                    ...
                    <p class="mb-4">© 2008 - <?php echo date("Y") ?> Startup.vn <br class="d-none d-lg-block"/>All rights
                        reserved.</p>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="widget">
                    ...
                    <address class="pe-xl-15 pe-xxl-17">Startup.vn</address>
                    <a href="mailto:#">admin@abc.vn</a><br/> 090.000.000
                </div>
                <!-- /.widget -->
            </div>
            <!-- /column -->
            ...
            <div class="col-md-12 col-lg-3">
                <div class="widget">
                    ...
                    <p class="mb-5">Đăng ký để nhận tin mới nhất từ Startup.</p>
...
<a href="https://zalo.me/0900000000" id="linkzalo" target="_blank" rel="noopener noreferrer"><div id="fcta-zalo-tracking" class="fcta-zalo-mess">
