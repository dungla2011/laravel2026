    ...
    <header class="blog-header py-3" style="color: #236db6!important;">
        <div class="row flex-nowrap justify-content-between align-items-center">
            <div class="col-4 pt-1">
                <a class="text-muted" href="/" style="color: #236db6!important;">HR</a>
            </div>
            <div class="col-4 text-center">
                <a class="blog-header-logo text-dark" href="/" style="color: #236db6!important;">Logo</a>
            </div>
            <div class="col-4 d-flex justify-content-end align-items-center">
                ...
                if(getUserIdCurrent_())
                    echo "<a class=\"btn btn-sm btn-primary\" href=\"/member\">Thành viên</a>";
                else
...
<main role="main" class="container" data-code-pos="ppp16820537586">
