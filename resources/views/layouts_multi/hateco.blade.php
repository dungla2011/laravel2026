<?php
    bl("Dịch vụ đang bảo dưỡng! <br>  <a href='https://GalaxyCloud.vn'> GalaxyCloud.vn</a> ");
return;
?>
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="/">
                ...
                if($img = $ui->getThumbInImageListWithNoImg())
                    echo "<img style='max-width: 230px; width: 230px' src='$img'/>" ;
                ?>
            </a>
            </div>
...
<footer>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 mt-1  qqqq1111">
