...
<header class="fixed-top" data-code-pos='ppp16966420188271'>
    ...
    <nav  class="nav navbar navbar-expand-lg bg-white sticky-top navbar-light shadow top-nav">
        ...
        <div class="container" data-code-pos='ppp03485034850'>

            <div class="qqqq1111 nav-div" style="min-width: 50px">
            <a class="navbar-brand" href="/" style="font-weight: bolder; color: orangered; font-size: 150%">
                <?php
                if($ui = \App\Models\BlockUi::showEditButtonStatic("logo-top-home-page")){
                    echo $ui->getSummary();
                }
...
<footer>
    ...
    <footer1>
        <div class="container">
            <a href="//galaxycloud.vn" target="_blank">
            Designed by © GalaxyCloud.vn
            </a>
        </div>
    </footer1>
</footer>
