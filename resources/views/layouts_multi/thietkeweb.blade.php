...
{{--    <script src="https://plugin.llmviet.one/static/js/main.js?v=1" defer></script>--}}
...
<div class="content-wrapper">
    <header class="wrapper mynav">

        <nav class="navbar navbar-expand-lg center-nav transparent navbar-light" data-code-pos='ppp17441103349341'
                    ...
                    <a href="/">
                        <h2 style="margin-top: 8px; margin-left: 10px">
                            ...
                            if($ui->getThumbInImageList())
                                echo '<img src="'.$ui->getThumbSmall().'" style="height: 40px">';
                            else
                                echo $ui->getSummary();
                            ?>
