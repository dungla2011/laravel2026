...
<head>
    ...
    <link href="/assert/css/temp_1.css?v=<?php echo 'v1' ?>" rel="stylesheet">

    <link href="/assert/css/lad-common.css?v=<?php echo 'v1' ?>" rel="stylesheet">
...
<div class="container-fluid p-0 top-nav-zone" data-code-pos='ppp17276610063291'
     style="">
    <div class="container p-0">
        ...
        <nav class="nav-cover" style="position: relative" data-code-pos='ppp17276610093901'>
            <div class="login-pc">
                <?php
                if(getCurrentUserId()){
                    echo "<a href='/member'>  <i class='fa fa-user-o' style='font-size: 90%'> </i>  Thành viên</a>";
                }
                else
            ...
            <ul class="ul-0">
                ...
                <li><a href="/member/file">Upload</a>
                </li>

                <li>
                    <a href="/search-file?search_string=phim&sort_by=new&limit=10&from_size=1024&to_size=2048&ext=">Search</a>
                </li>

                <li>
                    <a href="/buy-vip">Mua Vip</a>
                </li>

                <li><a href="#">Liên hệ</a></li>

                <li class="hide_pc"><a href="/login">Đăng nhập</a></li>

                <li>
                    <div class="input-group mt-2">
                        <input class="form-control border-right-0 border "
                               style="border-radius: 0px;
                               font-size: ; padding: 3px 8px; margin: 5px 0px 10px 20px" type="search" value="" placeholder="Tìm kiếm.."
                               id="example-search-input">
                        <span class="input-group-append">
                            <button class="btn btn-outline-secondary  border"
                                    style="border-radius: 0px; padding: 7px 6px; margin: 5px 0px" type="button">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4" style="text-align: left">
                <a class="logo-mobi bottom" href="/">Tài liệu chuẩn.net</a>
            </div>
            <div class="col-sm-4" style="text-align: left">
                <p>Liên hệ</p>
