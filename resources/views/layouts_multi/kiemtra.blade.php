...
<div class="offcanvas-menu-wrapper">
    ...
    <div class="offcanvas__logo">
        <a href="/"><img class="logo" src="/images/logo/test2.png" alt=""></a>
    </div>
                    ...
                    <ul>
                        ...
                        <li><a href="#">Game</a>
                            <ul class="child" style="">
                                <li style="">
                                    <a href="/game/duoi-hinh-bat-chu" style="display: inline">
                                        Đuổi hình Bắt chữ
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li><a href="/">Tài liệu</a>
                            ...
                            <ul class="child" style="">
                                <li style="border: 1px solid blue">
                                    ...
                                    <ul class="child"  style="transform: translateX(190px)">
                                        <li style=""> 10-1</li>
                                        <li> 2

                                            <ul class="child"  style="transform: translateX(190px)">
                                                <li style="background-color: red"> 10 -21</li>
                                                <li> 2 </li>
                                                <li> 3 </li>
                                            </ul>
                                ...
                                <li> Toán lớp 11
                                    <ul class="child"  style="transform: translateX(190px)">
                                        <li style="background-color: red"> 11 x1</li>
                                        <li> 2 </li>
                                        <li> 3 </li>
                                    </ul>
