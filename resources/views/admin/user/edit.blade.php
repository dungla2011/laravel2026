...
@section("content")
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item" ppp0857937374958><a href="#">ADD</a></li>
        ...
        <!-- Main content -->
        <form action="{{ route("admin.user.update", ['id'=>$data->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select  class="form-control select2_init" name="role_id[]" id="" multiple>
                                    ...
                                    @foreach($roles AS $role)
                                        <option value="{{$role->id}}" {{$roleUser->contains('id', $role->id) ? 'selected' : '' }} > {{$role->name}}</option>
                                    @endforeach
                                </select>
