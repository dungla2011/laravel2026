    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item" data-code-pos='ppp351148551'><a href="#">Edit</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <form action="{{ route("admin.demo.update", ['id'=>$data->id]) }}" method="post">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="tags[]" class="form-control tags_select_choose @error('tags') is-invalid @enderror" multiple="multiple">
                                    @foreach($data->joinTags AS $tagItem)
