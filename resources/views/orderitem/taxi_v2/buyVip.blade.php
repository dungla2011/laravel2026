...
$nAllow = \App\Models\MonitorUser::getCurrentNumberMonitorAllow($uid);
...
//                                    }
                                    ...
                                    echo "<div class='pricing-card $isPopular' data-card-id='$obj->id' data-pos='09898677989'>";
...
?>
                                    <ul class='package-features' data-pos='3475934795'>
                                        <li> Lắng nghe tin nhắn Zalo theo từ khoá lựa chọn</li>
                                        <li> Thông báo tới App 24/7</li>
                                    </ul>
<?php
                                    echo "</div>";
                                    $cc++;
