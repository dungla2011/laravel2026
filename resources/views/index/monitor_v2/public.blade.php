...
@section('content')
    ...
    <section class="wrapper bg-gradient-primary qqqq1111" data-code-pos='ppp17972708764011'>
    ...
    <section class="wrapper bg-light" data-code-pos='ppp721708725951' >
        <div class="container py-4 qqqq1111">
            ...
            <div style="text-align: center; border-top: 0px solid #eee;" class="mt-8 mb-3">
                <?php
                if($img  = $ui->getThumbInImageList()){
                ?>

                <img style="width: 100%; max-width: 1000px ;border: 1px solid #ddd; border-radius: 10px; padding: 10px;
