...
@section('title')
    Tập Đánh máy online Miễn phí, Không có Quảng cáo
@endsection

@section('description')
    Phần mềm Tập đánh máy Online, Miễn phí, Không quảng cáo, Theo dõi tiến độ, Thống kê luyện tập , Đánh 10 ngón nhanh, đánh 10 ngón siêu tốc
@endsection
...
@section("css")
    <link data-pos="121212" rel="stylesheet" type="text/css" href="/tool1/doing/typing.glx/style.5.css" />
...
@section('content')
    ...
    <div class="container mt-4" data-code-pos='ppp17394962091411'>

        <a data-code-pos='ppp17394962380301' href="/member/typing-history" style="float: right"> <i class="fa fa-hand-o-right"></i> Xem Kết quả </a>

        <div class="row">
            <div class="col-sm-3">
                @include("index.tap-danh-may.left-menu")
            </div>
            ...
            <div class="col-sm-9">
                <div>
                    ...
                    $fid = $_GET['fid'] ?? 0;
                    $strTyping = '';
                    $les = \App\Models\TypingLesson::find($fid);
                    if($fid && $les)
                        $strTyping = $les->type_text;
                    ...
                    ?>
                    <div id="typing" style="" data-code-pos='ppp16959516853941'>
                        <?php
                        if(!$strTyping){
                            echo "\n<div class='jumbotron pt-4 pb-5'>";
                            echo "\n <div style='text-align: center'> <img src='/images/go-10-ngon.jpg'> <br> ";
                            echo "\n <br> <h1> Chào mừng bạn đến với Phần mềm Luyện gõ 10 ngón! </h1></div><br>
Bạn vẫn chỉ dùng hai ngón tay để gõ bàn phím? <br> Bạn vẫn cần nhìn vào bàn phím trước khi gõ? <br>" .
                                "<br>- Phần mềm Luyện ngón giúp gõ nhanh hơn và không cần nhìn vào bàn phím!  <br>
- Báo cáo Lịch sử luyện tập
<br>
- Đặc biệt: Phần mềm <b>Miễn phí</b>  và Không chứa <b>quảng cáo</b> <br> " .
                                "<br> <b> Cách luyện tập: </b> tập từ bài đầu tiên, thứ tự bài tăng dần độ khó, cần đạt 100% chính xác, và đạt tốc độ Trung bình trở lên! <br> Tốc độ trung bình: từ 250 ký tự (50 từ)/phút, <br>Tốc độ Nhanh: từ 350 ký tự (70 từ)/phút, <br> Tốc độ Siêu nhanh: từ 600 ký tự (120 từ)/phút";

                            if(!getCurrentUserId()){
                                echo "<br/>\n";
                                echo "<br/>\n";
                                bl("Mời bạn <a href='/login'>ĐĂNG NHẬP</a> để lưu lại lịch sử luyện tập!");

                            }

                            echo "<br/>\n";

                            $link = \LadLib\Common\UrlHelper1::setUrlParamThisUrl('fid', 1);
                            echo "<div class='text-center mt-4'>
                            <a href='$link'> <button class='btn btn-primary'> Bắt đầu tập </button> </a>
                            &nbsp
                            <a href='/member/typing-history'> <button class='btn btn-warning 324234'> Xem kết quả </button> </a>
                            ...
                            echo "   <h1 style='display: inline-block' data-code-pos='ppp16959516991291'> Bài tập $les->id. $les->parent_name - $les->name </h1> ";

                            ?>

                        <div data-code-pos='ppp16959516810491' id="counter" class="shadow_counter">
                ...
                onkeypress="return OnKeyPress(this, event);"></textarea>
                    ...
                    <div id="typing_info">
                        <div id="suggestion" class="suggestion">
                            ...
                            <div class="kb">
                                <div id="key_101" class="key key_two key_tilde">
                                ...
                                <div id="key_212" class="key key_two key_bracket_lft">
                                    <div class="key_top">{</div>
                                    <div class="key_bottom">[</div>
                                </div>
                                <div id="key_213" class="key key_two key_bracket_rgt">
                                    <div class="key_top">}</div>
                                    <div class="key_bottom">]</div>
                                </div>
                                ...
                                <div id="key_311" class="key key_two key_semicolon">
                                    <div class="key_top">:</div>
                                    <div class="key_bottom">;</div>
                                </div>
                                <div id="key_312" class="key key_two key_apostrophe">
                                    <div class="key_top">&quot;</div>
                                    <div class="key_bottom">&#039;</div>
                                </div>
                                ...
                                <div id="key_410" class="key key_two key_comma">
                                    <div class="key_top">&lt;</div>
                                    <div class="key_bottom">,</div>
                                </div>
                                <div id="key_411" class="key key_two key_period">
                                    <div class="key_top">&gt;</div>
                                    <div class="key_bottom">.</div>
                                </div>
