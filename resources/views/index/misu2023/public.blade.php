...
@section('content')
    ...
    <div class="container pt-4 mt-3  qqqq1111" data-code-pos='ppp168667949'>
        ...
        <div class="txt-center mx-auto mt-3 mb-4" style="max-width: 1000px; font-size: larger">

            Lập trình được coi là ngôn ngữ toàn cầu giúp con tự tin hội nhập thời đại số 4.0. Hiểu được điều đó, bố mẹ
            lựa chọn cho con học lập trình từ sớm (tiểu học) để xây dựng nền tảng kiến thức công nghệ. Scratch chính là
            ngôn ngữ thông dụng nhất dành cho các con bắt đầu làm quen với lập trình. Scratch phát triển theo hướng
            tương tác trực quan, đồ họa sống động, giúp con nhanh chóng tiếp thu ngay từ những bài học đầu tiên.
  ...
  padding: 20px; ">
            ...
            <ul>
                <li>
                    ...
                    Làm quen kiến thức lập trình: Khoá học Scratch giúp con bước đầu tiếp xúc và hiểu được "điều kì
                    diệu" xảy ra
                    bên trong phần mềm máy tính. Con sẽ được dạy cách lập trình qua thao tác kéo thả đơn giản để tăng sự
                    hào
                    hứng và kích thích trí tò mò trước khi con chuyển sang các câu lệnh phức tạp hơn.
                </li>
                <li>
                    Rèn luyện tư duy, kích thích sáng tạo: Tại các lớp học, con học cách tư duy logic thông qua
                    việc
                ...
                <li>
                    Trau dồi kỹ năng mềm: Con được trau dồi các kỹ năng mềm như thiết kế, thuyết trình, làm việc nhóm.
                    Môi
                ...
                <li>
                    ...
                    Nuôi dưỡng đam mê công nghệ: Kết thúc mỗi khoá học, con có trong tay ít nhất 3 sản phẩm công nghệ
                    hoàn chỉnh
  ...
  padding: 20px;">
    ...
    <div class="container pt-2 mt-3  flex1" data-code-pos='ppp16857567667949'
        ...
        <div class="pt-2 pb-1 text-center text-white" style="background-color: orangered">

            <h2>Lập trình Scratch</h2>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="description" style="">
                                    <div>
                                        ...
                                        $str = "- Vẽ lưới chữ nhật với số ô dài rộng nhập vào từ bàn phím
- Vẽ bông hoa, tô cánh hoa nhiều màu
- Vẽ cầu vồng
...
Tương tự bài 12. Tìm một dãy con liên tục cực đại các số > 0 của dãy trên.
...
Bài toán tìm đường đi của con kiến từ A đến B
";
            ...
            <div style="max-width: 900px; margin: 0 auto ; text-align: center">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 txt-left">
                        ▶️ Mỗi tuần 1 buổi các bạn học sinh vừa học vừa chơi với những bài giảng trực quan, hấp dẫn. Mỗi
                        giờ học tập không hề nhàm chán và khô cứng mà cực kỳ cuốn hút Thầy cô giảng đến đâu các con cùng
                        thực thành đến đó, trẻ thích thú và nhanh chóng nắm bắt được các nguyên tắc cơ bản trong lập
                        trình Scratch ngay trong lớp học.
                        <br>
                        ▶️ Sau mỗi buổi học, từng con được kèm riêng 1-1 để con được chia sẻ ý tưởng và bài làm, hoặc
                        nếu con chưa hiểu chỗ nào thì thầy cô giảng thêm riêng.
                        <br>
                        ▶️ Các con đều mê khoá học này, vì có công cụ để sáng tạo, thể hiện được mọi điều mình thích,
                        cái gì tưởng tượng ra được cũng đều làm được với Scratch.
                    </div>
