...
@section('content')
    ...
    <section class="wrapper bg-gradient-primary1 qqqq1111" data-code-pos='ppp17376708764011'>
        ...
        ?>
        <div class="container pt-8 pt-md-8 pb-6 text-center glx1">
            <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                <div class="col-lg-7">
                    <figure><img class="" style="max-width: 600px; width: 100%" src="{{$img ?? '/template/sandbo/assets/img/concept/concept2.png'}}"
                ...
                <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start" data-code-pos='ppp17365784467911'>
                    ...
                    <span><a id="traiNghiemNgay" class="btn btn-primary rounded-pill me-2" href="/member">
        ...
        <div class="container">
            <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center" data-code-pos='ppp17372708105481'>
                <div class="col-lg-7 order-lg-2">
                    <figure><img class="w-auto" src=" {{ $img ?? '/template/sandbo/assets/img/concept/concept8.png' }} "
                                 srcset="{{ $img ?? '/template/sandbo/assets/img/concept/concept8.png' }} 2x" alt="" /></figure>
                </div>
                <?php
                $i = 1;
                ?>
