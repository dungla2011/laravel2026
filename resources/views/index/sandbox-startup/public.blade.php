        ...
        <div class="container pt-10 pt-md-14 pb-8 text-center">
            <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                ...
                <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start">
                    <h1 class="display-1 mb-5 mx-md-n5 mx-lg-0">Tư vấn khởi nghiệp.</h1>
                    <p class="lead fs-lg mb-7">
                        Số hoá & đánh giá sự án Kinh doanh
                    </p>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card flex-grow-1  shadow-lg  tinh-nang">
                            <div class="card-body">
                                ...
                                <p class="mb-2">
                                    <i class="uil uil-check fs-21"></i>
                                    Tìm Kiếm AI - thông minh với Bộ siêu lọc chỉ có tại Startup
                                </p>
                            </div>
                            <!--/.card-body -->
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    ...
                                    <p class="mb-2">Startup hỗ trợ API tốt và ổn định, tôi thường sử dụng để CDN file</p>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    ...
                                    <p class="mb-2">Tôi sử dụng Startup thường xuyên để gửi file lớn cho khách hàng của mình.</p>
                                    <nav class="nav social mb-0">
                                        <a href="#"><i class="uil uil-twitter"></i></a>
                                        <a href="#"><i class="uil uil-facebook-f"></i></a>
                                        <a href="#"><i class="uil uil-dribbble"></i></a>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    ...
                                    <p class="mb-2">Startup sử dụng để backup rất tốt. Dữ liệu của tôi đã lưu 15 năm trên đây</p>
                                    <nav class="nav social mb-0">
                                        <a href="#"><i class="uil uil-twitter"></i></a>
                                        <a href="#"><i class="uil uil-facebook-f"></i></a>
                                        <a href="#"><i class="uil uil-dribbble"></i></a>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    ...
                                    <p class="mb-2">Startup có kho tìm kiếm độc đáo, tìm cả các file chia sẻ hàng chục năm trước.</p>
                                    <nav class="nav social mb-0">
                                        <a href="#"><i class="uil uil-twitter"></i></a>
                                        <a href="#"><i class="uil uil-facebook-f"></i></a>
                                        <a href="#"><i class="uil uil-dribbble"></i></a>
