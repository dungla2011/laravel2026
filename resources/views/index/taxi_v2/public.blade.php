...
@section('content')
    ...
    <style>
        ...
        .img_center .meta,  .img_center .nav{
            text-align: center;
        }

    </style>

    <section class="wrapper bg-gradient-primary qqqq1111" data-code-pos='ppp173772708764011'>
        ...
        ?>
        <div class="container pt-10 pb-8 text-center">
            <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                <div class="col-lg-7">
                    <figure><img style="border-radius: 30px" class="w-a1uto" src="{{$img ?? '/template/sandbo/assets/img/concept/concept2.png'}}"
    ...
    <!-- /section -->
    <section class="wrapper bg-light" data-code-pos='ppp721708725951' >
        <div class="container py-4 qqqq1111">
            <?php
            $ui = \App\Models\BlockUi::showEditButtonStatic('download-app');
            $mText = explode("\n", $ui->getExtra());
            ...
            <div class="row justify-content-center align-items-center text-center" style="border-bottom: 0px solid #eee; ">
                <div class="col-auto">
                    <a href="{{$mText[0] ?? '#'}}" target="_blank" class="d-inline-block">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg"
                             alt="Get it on Google Play" style="height: 50px;">
                    </a>
                </div>
                <div class="col-auto">
                    <a href="{{$mText[1] ?? '#'}}" target="_blank" class="d-inline-block" id="get_app_store">
        ...
        <div class="content-app" style="max-width: 800px; margin: 0 auto; padding: 10px 20px">
    ...
    <section class="wrapper bg-light" data-code-pos='ppp17372708725951'>
        <div class="container pt-6 pt-md-6 qqqq1111">
            <?php
                ...
                $ui->showEditButton();
            // Tách text thành các khối, mỗi khối cách nhau bởi ít nhất 2 dấu xuống dòng
            $rawText = $ui->getExtra();
            $blocks = preg_split('/\n\s*\n/', $rawText, -1, PREG_SPLIT_NO_EMPTY);

            // Xử lý mỗi khối: dòng đầu là title, các dòng sau là nội dung
            $featureBlocks = [];
            foreach ($blocks as $block) {
                ...
                if (!empty($lines)) {
                    $featureBlocks[] = [
                        'title' => $lines[0] ?? '',
                        'items' => array_slice($lines, 1)
                    ];
                }
            }

            // Định nghĩa icon và màu cho mỗi khối
            $icons = [
                ['icon' => '/template/sandbo/assets/img/icons/search-1.svg', 'color' => 'text-yellow'],
                ['icon' => '/template/sandbo/assets/img/icons/browser.svg', 'color' => 'text-red'],
                ['icon' => '/template/sandbo/assets/img/icons/chat-2.svg', 'color' => 'text-green'],
                ['icon' => '/template/sandbo/assets/img/icons/megaphone.svg', 'color' => 'text-blue'],
            ];
...
{{--                    <h3 class="display-4 mb-10 px-xl-10">The service we offer is specifically designed to meet your needs.</h3>--}}
                    <h3 class="display-4 mb-10 px-xl-10">{{$ui->getNameMlang() ?? 'not set name'}}</h3>
            ...
            <div class="position-relative" data-code-pos='ppp17372708695701'>
                ...
                <div class="row gx-md-5 gy-5 ">
                    <?php foreach ($featureBlocks as $index => $block): ?>
                        <?php
                            $iconData = $icons[$index % count($icons)];
                        ?>
                        <div class="col-md-6 col-xl-3">
                            <div class="card flex-grow-1 shadow-lg tinh-nang">
                                <div class="card-body">
                                    <img src="<?php echo $iconData['icon']; ?>" class="svg-inject icon-svg icon-svg-md <?php echo $iconData['color']; ?> mb-3" alt="" />
...
?>
                    ...
                    <div class="row grid-view gy-6 gy-xl-0">
                        <div class="col-md-6 col-xl-3">
                            <div class="card shadow-lg">
                                <div class="card-body img_center">
    ...
    <section class="wrapper bg-light pb-8 mt-5 qqqq1111" data-code-pos='ppp17372708163901'>
        <?php
            $ui->showEditButton();
        $mImg = $ui->getAllImageList();
        $txt = $ui->getName();
        ...
        <div class="container">
            <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                <h2 class="center" style="text-align: center;"> {{$txt}} </h2>
                <div class="col-sm-12 partner " style="margin-top: 10px">
                    <?php
                    if($mImg)
                        foreach ($mImg as $img)
    ...
    <script>
        window.addEventListener('DOMContentLoaded', (event) => {
            ...
            // Chặn link App Store và hiển thị popup
            const appStoreLink = document.getElementById('get_app_store');
            if (appStoreLink) {
                appStoreLink.addEventListener('click', function(e) {
                    e.preventDefault(); // Chặn không cho theo link
                    alert('The iOS app is under construction!\nPhien ban IOS dang xay dung!');
                    return false;
                });
            }
