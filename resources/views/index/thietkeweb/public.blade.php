...
@section('content')
    ...
    <section class="section-frame mx-xxl-11 overflow-hidden">
        <div class="wrapper image-wrapper bg-image bg-cover bg-overlay bg-overlay-light-500" data-image-src="https://penji.co/wp-content/uploads/2024/09/10_Web_Banner_Examples.jpg.webp"
             style="background-image: url(&quot;https://penji.co/wp-content/uploads/2024/09/10_Web_Banner_Examples.jpg.webp&quot;);">
            <div class="container py-16 py-md-18 text-center position-relative">
                <div class="row">
                    <div class="col-lg-12 col-xxl-12 mx-auto" style="color: white">
                        <h1 class="fs-70 px-md-2 px-lg-0 px-xl-2 mb-2" style="color: white">
