...
Route2::prefix('/product-attribute')->group(function () {
    ...
    $route_group_desc = 'API - Thao tác với ProductAttribute';
    $nameModule = 'product-attribute';
    $modelUsing_ = \App\Models\ProductAttribute::class;

    $cls = \App\Http\ControllerApi\ProductAttributeControllerApi::class;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Lấy thông tin product-attribute';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Thêm product-attribute';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật product-attribute';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật product-attribute - multi';
    $r->modelUsing_ = $modelUsing_;
    $r->showApi_ = 0;
    //
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Xóa product-attribute';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Khôi phục product-attribute';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Tree list ProductAttribute';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Tạo ProductAttribute tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Rename ProductAttribute tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Delete ProductAttribute tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Move on ProductAttribute tree';
