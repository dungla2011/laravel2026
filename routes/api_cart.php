...
Route2::prefix('/cart')->group(function () {
    ...
    $route_group_desc = 'API - Thao tác với Cart';
    $nameModule = 'cart';
    $modelUsing_ = \App\Models\Cart::class;

    $cls = \App\Http\ControllerApi\CartControllerApi::class;


    $routeName = 'api.'.$nameModule.'.add_to_cart';
    $r = Route2::post('/add_to_cart', [
        \App\Http\ControllerApi\CartControllerApi::class, 'add_to_cart',
    ])->name($routeName);
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Lấy thông tin cart';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật cart - multi';
    $r->modelUsing_ = $modelUsing_;
    $r->showApi_ = 0;
    //
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Rename Cart tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Delete Cart tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Move on Cart tree';
