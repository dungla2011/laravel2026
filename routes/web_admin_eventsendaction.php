...
Route2::prefix('admin')->group(function () {
    ...
    Route2::prefix('event-send-action')->group(function () {
        ...
        $routeName = 'admin.event-send-action.index';
        $r = Route2::get('/', [
        ...
        $routeName = 'admin.event-send-action.edit';
        ...
        $routeName = 'admin.event-send-action.create';
        $r = Route2::get('/create',
        ...
        $routeName = 'admin.event-send-action.tree';
        $r = Route2::get('/tree', [
