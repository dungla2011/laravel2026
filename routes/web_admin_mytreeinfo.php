...
Route2::prefix('admin')->group(function () {
    ...
    Route2::prefix('my-tree-info')->group(function () {
        $route_group_desc = 'Thao tác với MyTreeInfo';

        $routeName = 'admin.my-tree-info.index';
        $r = Route2::get('/', [
        ...
        $routeName = 'admin.my-tree-info.edit';
        ...
        $routeName = 'admin.my-tree-info.create';
        $r = Route2::get('/create',
        ...
        $routeName = 'admin.my-tree-info.tree';
        $r = Route2::get('/tree', [
