...
Route2::prefix('admin')->group(function () {
    ...
    Route2::prefix('event-send-info-log')->group(function () {
        ...
        $routeName = 'admin.event-send-info-log.index';
        $r = Route2::get('/', [
        ...
        $routeName = 'admin.event-send-info-log.edit';
        ...
        $routeName = 'admin.event-send-info-log.create';
        $r = Route2::get('/create',
        ...
        $routeName = 'admin.event-send-info-log.tree';
        $r = Route2::get('/tree', [
