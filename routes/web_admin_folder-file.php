...
Route2::prefix('admin')->group(function () {
    ...
    Route2::prefix('folder-file')->group(function () {
        ...
        $routeName = 'admin.folder-file.index';
        $r = Route2::get('/', [
        ...
        $routeName = 'admin.folder-file.edit';
        ...
        $routeName = 'admin.folder-file.create';
        $r = Route2::get('/create',
        ...
        //
        //        $routeName = "admin.folder-file.add";
        //        $r = Route2::post("/add", [
        ...
        ////
        ////
        //        $routeName = "admin.folder-file.update";
        ...
        ////
        //        $routeName = "admin.folder-file.delete";
        ...
        $routeName = 'admin.folder-file.tree';
        $r = Route2::get('/tree', [
