...
Route2::prefix('/order-info')->group(function () {
    ...
    $routeName = 'api.'.$nameModule.'.call_back_ghtk';
    $r = Route2::match(['GET', 'POST'], '/call_back_ghtk', [
        \App\Http\ControllerApi\OrderInfoControllerApi::class, 'call_back_ghtk',
    ])->name($routeName);
    if ($r instanceof Route2);
    //$r->middleware("can:" . $routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Xem call_back_ghtk';
