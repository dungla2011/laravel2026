...
Route2::prefix('/hr-org-setting')->group(function () {
    ...
    $route_group_desc = 'API - Thao tác với HrOrgSetting';
    $nameModule = 'hr-org-setting';
    $modelUsing_ = \App\Models\HrOrgSetting::class;

    $cls = \App\Http\ControllerApi\HrOrgSettingControllerApi::class;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Lấy thông tin hr-org-setting';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Thêm hr-org-setting';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật hr-org-setting';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật hr-org-setting - multi';
    $r->modelUsing_ = $modelUsing_;
    $r->showApi_ = 0;
    //
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Xóa hr-org-setting';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Khôi phục hr-org-setting';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Tree list HrOrgSetting';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Tạo HrOrgSetting tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Rename HrOrgSetting tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Delete HrOrgSetting tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Move on HrOrgSetting tree';
