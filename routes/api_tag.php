...
Route2::prefix('/tag')->group(function () {
    ...
    $route_group_desc = 'API - Thao tác với TAG';
    $nameModule = 'tag';
    $modelUsing_ = \App\Models\Tag::class;

    $cls = \App\Http\ControllerApi\TagsControllerApi::class;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Rename Demo tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Delete Demo tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Move on Demo tree';
