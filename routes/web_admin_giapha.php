...
Route2::prefix('admin')->group(function () {
    ...
    Route2::prefix('tree-mng')->group(function () {
        ...
        $routeName = 'admin.tree-mng.index';
        $r = Route2::get('/', [
        ...
        $routeName = 'admin.tree-mng.create';
        $r = Route2::get('/create',
        ...
        $routeName = 'admin.tree-mng.tree';
        $r = Route2::get('/tree', function () {
            return 'Not work tree in admin!';
