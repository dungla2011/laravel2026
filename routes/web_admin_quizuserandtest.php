...
Route2::prefix('admin')->group(function () {
    ...
    Route2::prefix('quiz-user-and-test')->group(function () {
        ...
        $routeName = 'admin.quiz-user-and-test.index';
        $r = Route2::get('/', [
        ...
        $routeName = 'admin.quiz-user-and-test.edit';
        ...
        $routeName = 'admin.quiz-user-and-test.create';
        $r = Route2::get('/create',
        ...
        $routeName = 'admin.quiz-user-and-test.tree';
        $r = Route2::get('/tree', [
