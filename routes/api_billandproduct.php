...
Route2::prefix('/order-item')->group(function () {
    ...
    $route_group_desc = 'API - Thao tác với OrderItem';
    $nameModule = 'order-item';
    $modelUsing_ = \App\Models\OrderItem::class;

    $cls = \App\Http\ControllerApi\OrderItemControllerApi::class;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Lấy thông tin order-item';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật order-item';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật order-item - multi';
    $r->modelUsing_ = $modelUsing_;
    $r->showApi_ = 0;
    //
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Khôi phục order-item';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Tree list OrderItem';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Tạo OrderItem tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Rename OrderItem tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Delete OrderItem tree';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Move on OrderItem tree';
