...
Route2::prefix('/file-share-permission')->group(function () {
    ...
    $nameModule = 'file-share-permission';
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Lấy thông tin file-share-permission';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Thêm file-share-permission';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật file-share-permission';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật file-share-permission - multi';
    $r->modelUsing_ = $modelUsing_;
    $r->showApi_ = 0;
    //
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Xóa file-share-permission';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Khôi phục file-share-permission';
    $r->modelUsing_ = $modelUsing_;
