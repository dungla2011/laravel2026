...
Route2::prefix('member')->group(function () {
    ...
    Route2::prefix('event-user-info')->group(function () {
        ...
        $routeName = 'member.event-user-info.index';
        $r = Route2::get('/', [
        ...
        $routeName = 'member.event-user-info.edit';
        ...
        $routeName = 'member.event-user-info.create';
        $r = Route2::get('/create',
        ...
        $routeName = 'member.event-user-info.tree';
        $r = Route2::get('/tree', [
