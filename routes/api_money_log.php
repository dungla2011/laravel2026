...
Route2::prefix('/money-log')->group(function () {
    ...
    $route_group_desc = 'API - Thao tác với MoneyLog';
    $nameModule = 'money-log';
    $modelUsing_ = \App\Models\MoneyLog::class;

    $cls = \App\Http\ControllerApi\MoneyLogControllerApi::class;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Lấy thông tin money-log';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật money-log - multi';
    $r->modelUsing_ = $modelUsing_;
    $r->showApi_ = 0;
    //
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Khôi phục money-log';
    $r->modelUsing_ = $modelUsing_;
