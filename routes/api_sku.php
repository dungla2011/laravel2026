...
Route2::prefix('/sku')->group(function () {
    ...
    $route_group_desc = 'API - Thao tác với Sku';
    $nameModule = 'sku';
    $modelUsing_ = \App\Models\Sku::class;

    $cls = \App\Http\ControllerApi\SkuControllerApi::class;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Lấy thông tin sku';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật sku - multi';
    $r->modelUsing_ = $modelUsing_;
    $r->showApi_ = 0;
    //
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Move on Sku tree';
