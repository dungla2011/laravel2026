...
Route2::prefix('/todo2')->group(function () {
    ...
    $route_group_desc = 'API - Thao tác với Todo2';
    $nameModule = 'todo2';
    $modelUsing_ = \App\Models\Todo2::class;

    $cls = \App\Http\ControllerApi\Todo2ControllerApi::class;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Lấy thông tin todo2';
    $r->modelUsing_ = $modelUsing_;
    ...
    $r->middleware('can:'.$routeName);
    $r->route_group_desc_ = $route_group_desc;
    $r->route_desc_ = 'Cập nhật todo2 - multi';
    $r->modelUsing_ = $modelUsing_;
    $r->showApi_ = 0;
    //
